    ...
    <div class="backf5 box">
      <div class="containerAuto back3f container">
        ...
        <div class="miniprice flex-sba">
          ...
          <div>
            <div class="flex-end" style="width: 250px">
              <div class="flex1">商品件数</div>
              <div class="Themecolor flex1 textl">4件</div>
            </div>
            <div class="flex-sb">
              <div class="flex1">商品总价</div>
              <div class="Themecolor flex1 textl">1146元</div>
            </div>
            <div class="flex-sb">
              <div class="flex1">优惠券抵扣</div>
              <div class="Themecolor flex1 textl">-70</div>
            </div>
            <div class="flex-sb">
              <div class="textl flex1">商品件数</div>
              <div class="Themecolor flex1 textl">4件</div>
            </div>
          </div>
        </div>
