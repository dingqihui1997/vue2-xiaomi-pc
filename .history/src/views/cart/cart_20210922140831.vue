...
import CartUser from "../../components/cartUser/cartUser.vue";
export default {
  name: "",
  props: {},
  data() {
  ...
  components: { CatrTop, GoodList, CartUser },
  methods: {
    getCart() {
      this.$api
    ...
    gotobuy() {
      if (this.num.length) {
        localStorage.setItem("goods", JSON.stringify(this.num));
