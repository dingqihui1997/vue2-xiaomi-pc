            ...
            <Form ref="register" :model="register" :rules="ruleRegister">
              ...
              <FormItem>
                <button
                  ...
                  :rules="ruleRegister"
                >
                  @click.prevent="registerSubmit('register', )" style="width:
                  100%; height: 60px" :disabled=" !( register.password &&
                  register.username && register.mobile && register.code ) "
                  class="color3f" :class=" register.password &&
                  register.username && register.mobile && register.code ? 'ipt1'
                  : 'ipt' " > 注册
                </button>
              </FormItem>
            </Form>
