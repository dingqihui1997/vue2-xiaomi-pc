<template>
  <div class="home-hero container">
    ...
    <div class="home-hero-sub flex">
      ...
      <div class="flex span3">
        <div class="flex1 margin-l10">
          <img src="../../assets/1-1.jpg" class="img100" />
        </div>
        <div class="flex1 margin-l10">
          <img src="../../assets/1-2.jpg" class="img100" />
        </div>
        <div class="flex1 margin-l10">
          <img src="../../assets/1-3.png" class="img100" />
        </div>
      </div>
    </div>
  </div>
