<template>
  <div>
    <div class="containerAuto product flex">
      ...
      <div class="flex1 mal20">
        ...
        <div class="address">
          ...
          {{ address }}
          <span class="Themecolor" @click="modify">修改</span>
        </div>
        <!-- 规格 -->
    ...
    <Address :show="show" @send="send" @chioce="chioce"></Address>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getLocation() {
      ...
      AMap.plugin("AMap.Geolocation", function () {
        ...
        function onComplete(data) {
          ...
          let district = data.addressComponent.district;
          let township = data.addressComponent.township;
          that.address = `${province} ${city} ${district} ${township}`;
        }
    ...
    chioce(val) {
      this.address = val.address + val.detailAddress;
    },
  },
  mounted() {
    this.getLocation();
