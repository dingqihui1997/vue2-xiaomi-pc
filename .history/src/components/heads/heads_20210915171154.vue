  ...
  <div class="top">
    ...
    <div class="head">
      <div class="container hei100 headbox flex-a">
        ...
        <div class="flex navbox" ref="content">
          <div
    ...
    <!-- hover -->
    <div class="navhover" v-if="show" @mouseleave="removebox">
...
export default {
  ...
  methods: {
    ...
    remove(e) {
      ...
      // if (Math.abs(top - e.pageY) > 22) this.show = false;
    },
    // 大盒子移除
    removebox(e) {
      let top = this.$refs.content.getBoundingClientRect().top;
      console.log(Math.abs(top - e.pageY));
      if (Math.abs(top - e.pageY) > 100) this.show = false;
    },
  },
  mounted() {
    this.getdata();
